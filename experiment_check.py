                    ...
                    for img in images:
                        ...
                        for seed in range(num_seeds):
                            ...
                            if not os.path.exists(poses_fp):
                                ...
                                mismatched_paths.append(f'{seed_dir}')
                                continue
                            try:
...
if __name__ == '__main__':
    ...
    # modes = ['interpolation/1000', 'interpolation/2000', 'interpolation/3000',
    #          'corpus/1000', 'corpus/2000', 'corpus/3000']
    modes = ['interpolation/1000', 'corpus/1000']
